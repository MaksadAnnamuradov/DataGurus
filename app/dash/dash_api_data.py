...
client = Socrata(socrata_domain, app_token="T5AhNmGSl123reIiEdBeYZ235")
...
layout = html.Div([
    ...
    dcc.Interval(id="timer", interval=100000*7, n_intervals=0),
    dcc.Store(id="stored", data={}),

    html.Div(id="api-output-div", children=[]),
])
...
@app.callback(Output("api-output-div", "children"),
