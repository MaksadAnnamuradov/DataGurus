...
#-------------------------------------------------------
mapbox_access_token = "pk.eyJ1IjoibWFrc2FkYW5uYW11cmFkb3YiLCJhIjoiY2t5dXVocjQwMDI4MTJvcXVxbW9iYWNzMiJ9.oudp8_K1D3fhnXtdJACiVg"
...
df = pd.read_csv(DATA_PATH.joinpath("finalrecycling.csv"))
